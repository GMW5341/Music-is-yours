...
const GENRE_DEFAULTS: Record<Genre, { bpm: number; key: Key; instruments: string[]; trackTypes: TrackLayer["type"][] }> = {
  ...
  rnb: { bpm: 85, key: "G#", instruments: ["electric_piano", "bass_synth", "pad", "drum_machine"], trackTypes: ["melody", "harmony", "bass", "drums"] },
  jazz: { bpm: 110, key: "A#", instruments: ["piano", "upright_bass", "saxophone", "brush_drums"], trackTypes: ["melody", "harmony", "bass", "drums"] },
  ...
  soul: { bpm: 90, key: "A#", instruments: ["electric_piano", "brass_section", "bass_guitar", "soul_drums"], trackTypes: ["melody", "harmony", "bass", "drums"] },
